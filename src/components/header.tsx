...
export const Header = () => {
  ...
  return (
    <header className="absolute top-0 left-1/2 -translate-x-1/2 z-30 w-80 sm:w-96 flex justify-between items-center gap-6 bg-white px-6 py-4 shadow-md shadow-zinc-400 rounded-b-3xl">
