...
export const Hero = () => {
  ...
  return (
    <section id="hero" className="relative w-full h-screen bg-[url('/hero/hero.jpg')] bg-cover bg-left sm:bg-center">
      <div className={containerStyle + ' flex justify-center items-center flex-col md:flex-row gap-4 z-10'}>
        <div className="flex-1 flex flex-col gap-4">
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold sourGummy">Coma Bem, Viva Melhor.</h1>
