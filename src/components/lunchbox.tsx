...
export const LunchboxItem = ({ item }: props) => {
   ...
   return (
      <div key={item.id} className="group flex flex-col justify-center items-center bg-white p-4 rounded-xl cursor-pointer shadow-lg shadow-zinc-400 border hover:border-zinc-400 transition space-y-2">
         ...
         <p className="text-xl font-bold text-center my-2">{item.name}</p>
